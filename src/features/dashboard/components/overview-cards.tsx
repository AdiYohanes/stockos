    ...
    >
      {metrics.map((metric) => {
        ...
        return (
          ...
          >
            <CardContent className="p-4 sm:p-4.5 flex flex-col justify-between h-full gap-2">
              {/* Header: Label + Icon */}
              <div className="flex items-center justify-between gap-2">
                <span className="font-mono text-xs font-semibold text-muted-foreground uppercase tracking-wider truncate">
                  {metric.label}
                </span>
                <div
                  className={cn(
